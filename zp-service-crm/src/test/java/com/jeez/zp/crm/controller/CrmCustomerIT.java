...
class CrmCustomerIT {
    ...
    private void resetCustomers() {
        jdbcTemplate.update("DELETE FROM crm_customer_tag_rel WHERE customer_id BETWEEN 41001 AND 41003");
        jdbcTemplate.update("DELETE FROM crm_customer WHERE camp_id = ? AND customer_id BETWEEN 41001 AND 41003", CAMP_ID);
    }
