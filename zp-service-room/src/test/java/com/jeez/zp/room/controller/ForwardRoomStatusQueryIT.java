...
@ActiveProfiles("test")
@Transactional
class ForwardRoomStatusQueryIT {

    private static final String AUTH_VERIFIED_HEADER = "X-Auth-Verified";
    private static final String USER_ID_HEADER = "X-User-Id";
    private static final long CURRENT_USER_ID = 12001L;
    private static final long ISOLATED_CAMP_ID = 125001L;
    private static final long ISOLATED_POI_ID = 125021L;
    private static final long ROOM_CATEGORY_A_ID = 125031L;
    private static final long ROOM_CATEGORY_B_ID = 125032L;
    private static final long ROOM_A_1_ID = 125041L;
    private static final long ROOM_A_2_ID = 125042L;
    private static final long ROOM_A_3_ID = 125043L;
    private static final long ROOM_B_1_ID = 125044L;
    private static final long ROOM_B_2_ID = 125045L;
    ...
    void forwardRoomStatusGet_shouldReturnForwardStatusRows() throws Exception {
        ...
        mockMvc.perform(post("/report/forwardRoomStatus/get")
                ...
                .andExpect(jsonPath("$.data.list[0].roomCategoryId").value("125031"))
                ...
                .andExpect(jsonPath("$.data.list[1].roomCategoryId").value("125032"))
    ...
    private void seedRoomSituationScene() {
        ...
        insertPoi();
        insertRoomCategory(ROOM_CATEGORY_A_ID, "TDD远期房型A", 10, 3);
        insertRoomCategory(ROOM_CATEGORY_B_ID, "TDD远期房型B", 20, 2);
        ...
        insertOrderMain(125061L, ROOM_CATEGORY_A_ID, ROOM_A_1_ID, "booked", "paid",
                "远期预订客人", "13900002001", TARGET_DATE, TARGET_DATE.plusDays(1), TARGET_DATE.minusDays(1).atTime(9, 0), "forward arrival");
        insertOrderMain(125062L, ROOM_CATEGORY_B_ID, ROOM_B_1_ID, "checked_in", "paid",
                "远期在住客人", "13900002002", TARGET_DATE.minusDays(1), TARGET_DATE, TARGET_DATE.minusDays(2).atTime(10, 0), "forward leaving");
    }
