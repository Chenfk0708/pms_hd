...
class RoomStatusesTodayQueryIT {
    ...
    private static final long POI_ID = 123121L;
    ...
    void roomStatusesTodayGet_shouldReturnRoomTypeViewUsingLiveLegacyShape() throws Exception {
        ...
        mockMvc.perform(post("/roomStatusesToday/get")
                ...
                .andExpect(jsonPath("$.data.roomCategories[0].roomCategoryId").value("123221"))
                ...
                .andExpect(jsonPath("$.data.roomCategories[0].rooms[0].roomId").value("123421"))
                ...
                .andExpect(jsonPath("$.data.roomCategories[0].rooms[0].orders[0].orderId").value("123621"))
                .andExpect(jsonPath("$.data.roomCategories[0].rooms[0].orders[0].channelName").value("路客云聚合"))
                .andExpect(jsonPath("$.data.roomCategories[1].roomCategoryId").value("123222"))
    ...
    void roomStatusesTodayGet_shouldSupportCurrentFrontendViewModeKeywordAndStatusFilters() throws Exception {
        ...
        mockMvc.perform(post("/roomStatusesToday/get")
                ...
                .andExpect(jsonPath("$.data.roomViews[0].roomId").value("123421"))
                ...
                .andExpect(jsonPath("$.data.roomViews[0].orders[0].orderId").value("123621"));
    }
    ...
    void roomStatusesTodayGet_shouldFallbackInvalidCampIdForFloorViewAndRejectForeignCamp() throws Exception {
        ...
        mockMvc.perform(post("/roomStatusesToday/get")
                ...
                .andExpect(jsonPath("$.data.floorViews[0].floorId").value("123321"))
                .andExpect(jsonPath("$.data.floorViews[0].floorName").value("9F"))
                .andExpect(jsonPath("$.data.floorViews[0].rooms.length()").value(2))
                .andExpect(jsonPath("$.data.floorViews[1].floorId").value("123322"))
    ...
    private void seedRoomStatusesTodayScene() {
        ...
        insertRoomCategory(123221L, POI_ID, 123101L, "TDD今日房态A", 10);
        insertRoomCategory(123222L, POI_ID, 123101L, "TDD今日房态B", 20);
        insertFloor(123321L, POI_ID, "9F", 9);
        insertFloor(123322L, POI_ID, "10F", 10);
        insertRoom(123421L, 123221L, 123321L, "A-901", "clean", 1);
        insertRoom(123422L, 123221L, 123321L, "A-902", "clean", 2);
        insertRoom(123423L, 123222L, 123322L, "B-1001", "dirty", 1);
        insertRoom(123424L, 123222L, 123322L, "B-1002", "dirty", 2);
        insertChannelAccount(123521L, 17L, "路客云聚合");
        insertChannelAccount(123522L, 5L, "携程");

        insertOrderMain(123621L, 123521L, 123221L, 123421L, "booked", "paid", "张三", "13900000001",
                TARGET_DATE, TARGET_DATE.plusDays(1), TARGET_DATE.minusDays(1).atTime(9, 0), "需无烟房");
        insertOrderMain(123622L, 123522L, 123221L, 123422L, "checked_in", "paid", "李四", "13900000002",
                TARGET_DATE.minusDays(1), TARGET_DATE, TARGET_DATE.minusDays(2).atTime(10, 0), null);
        insertOrderMain(123623L, 123522L, 123222L, 123423L, "checked_in", "paid", "王五", "13900000003",
