...
@ActiveProfiles("test")
@Transactional
class DailyRoomStatusQueryIT {

    private static final String AUTH_VERIFIED_HEADER = "X-Auth-Verified";
    private static final String USER_ID_HEADER = "X-User-Id";
    private static final long CURRENT_USER_ID = 12001L;
    private static final long ISOLATED_CAMP_ID = 124001L;
    private static final long ISOLATED_POI_ID = 124021L;
    private static final long ROOM_CATEGORY_A_ID = 124031L;
    private static final long ROOM_CATEGORY_B_ID = 124032L;
    private static final long ROOM_A_1_ID = 124041L;
    private static final long ROOM_A_2_ID = 124042L;
    private static final long ROOM_A_3_ID = 124043L;
    private static final long ROOM_B_1_ID = 124044L;
    private static final long ROOM_B_2_ID = 124045L;
    ...
    void dailyRoomStatusGet_shouldReturnCurrentFrontendShape() throws Exception {
        ...
        mockMvc.perform(post("/report/dailyRoomStatus/get")
                ...
                .andExpect(jsonPath("$.data.list[0].roomCategoryId").value("124031"))
                ...
                .andExpect(jsonPath("$.data.list[1].roomCategoryId").value("124032"))
    ...
    private void seedRoomSituationScene() {
        ...
        insertOrderMain(124061L, ROOM_CATEGORY_A_ID, ROOM_A_1_ID, "booked", "paid",
                "今日预抵客人", "13900001001", TARGET_DATE, TARGET_DATE.plusDays(1), TARGET_DATE.minusDays(1).atTime(9, 0), "room situation arrival");
        insertOrderMain(124062L, ROOM_CATEGORY_B_ID, ROOM_B_1_ID, "checked_in", "paid",
