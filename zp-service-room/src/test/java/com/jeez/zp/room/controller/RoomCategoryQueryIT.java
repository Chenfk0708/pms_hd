...
class RoomCategoryQueryIT {
    ...
    void roomCategoriesPageGet_shouldReturnPagedRowsWithRoomsPoiAndProductInfo() throws Exception {
        insertRoomCategory(112001L, "TDD房型A", 2, 26800L, 28800L, 30800L, 14, 23, 12, 10);
        insertRoomCategory(112002L, "TDD房型B", 1, 36800L, 38800L, 40800L, 15, 24, 13, 20);
        insertRoom(113001L, 112001L, "A-101");
        insertRoom(113002L, 112001L, "A-102");
        insertRoom(113003L, 112002L, "B-201");
        insertMedia(114001L, "https://example.com/tdd-room-a.jpg");
        insertMedia(114002L, "https://example.com/tdd-room-b.jpg");
        insertRoomCategoryMedia(115001L, 112001L, 114001L, "https://example.com/tdd-room-a.jpg");
        insertRoomCategoryMedia(115002L, 112002L, 114002L, "https://example.com/tdd-room-b.jpg");
        ...
        mockMvc.perform(post("/roomCategories/page/get")
                ...
                .andExpect(jsonPath("$.data.list[0].roomCategoryId").value("112001"))
                ...
                .andExpect(jsonPath("$.data.list[1].roomCategoryId").value("112002"));
    }

    @Test
    @Timeout(60)
    void roomCategoriesPageGet_shouldFilterByChannelId() throws Exception {
        insertRoomCategory(112101L, "渠道筛选房型A", 1, 18800L, 20800L, 22800L, 14, 23, 12, 10);
        insertRoomCategory(112102L, "渠道筛选房型B", 1, 19800L, 21800L, 23800L, 14, 23, 12, 20);
        insertChannelRelation(116101L, 25301L, 112101L, "MT-TEST-001");
        insertChannelRelation(116102L, 25302L, 112102L, "CTRIP-TEST-002");
        ...
        mockMvc.perform(post("/roomCategories/page/get")
                ...
                .andExpect(jsonPath("$.data.list[0].roomCategoryId").value("112101"))
