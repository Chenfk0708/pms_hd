...
class FullMarketingQueryIT {
    ...
    private void seedFullMarketingData() {
        ...
        insertDistributionProduct(62001L, 61001L, 22001L, "{\"directRatio\":6,\"parentRatio\":2}");
        insertDistributionProduct(62002L, 61002L, 22002L, "{\"directRatio\":5,\"parentRatio\":1}");
        insertOrder(63001L, 61001L, 22001L, 68000L, 17001L, "FM-63001", LocalDateTime.of(2036, 5, 29, 9, 0));
        insertOrder(63002L, 61002L, 22002L, 32000L, 17002L, "FM-63002", LocalDateTime.of(2036, 5, 29, 10, 0));
    ...
    private void insertOrder(long orderId, long goodsId, long roomCategoryId, long totalPayCent, long channelId, String orderNo, LocalDateTime createdAt) {
        jdbcTemplate.update("""
