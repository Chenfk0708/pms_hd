...
import com.jeez.zp.platform.mapper.RoomSituationReportMapper;
import com.jeez.zp.platform.service.RoomSituationReportService;
import com.jeez.zp.platform.vo.CurrentUserBundleVO;
import com.jeez.zp.platform.vo.DailyRoomStatusRowVO;
import com.jeez.zp.platform.vo.ForwardRoomStatusDayVO;
import com.jeez.zp.platform.vo.ForwardRoomStatusRowVO;
...
public class RoomSituationReportServiceImpl implements RoomSituationReportService {
    ...
    public RoomSituationPageResponseVO getDailyRoomStatus(
        ...
        List<RoomSituationInventoryRowVO> inventoryRows = roomSituationReportMapper.selectInventoryRows(resolvedCampId, normalizeIds(poiIds));
    ...
    private Long resolveAccessibleCampId(Long requestedCampId, Long userId) {
        ...
        if (!requestedCampId.equals(bundle.getCampId())) {
            throw new BusinessException(40301, "no access to current camp room situation report");
        }
